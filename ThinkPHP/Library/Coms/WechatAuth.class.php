...
class WechatAuth {
    ...
    // const MENU_TYPE_SCANCODE_PUSH     = 'scancode_push';
    // const MENU_TYPE_SCANCODE_WAITNSG     = 'scancode_waitmsg';
    // const MENU_TYPE_PIC_SYSPHOTO     = 'pic_sysphoto';
    // const MENU_TYPE_PIC_PHOTO_OR_ALBUM     = 'pic_photo_or_album';
    // const MENU_TYPE_PIC_WEIXIN     = 'pic_weixin';
    ...
    public function getAccessToken($type = 'client', $code = null){
        ...
        if(is_array($token)){
            if(isset($token['errcode'])){
                ...
                //保存access_token减少开销
                cookie("access_token",$token['access_token'],array('expire'=>7000,'prefix'=>'wechat_'));
                return $token;
            }
        } else {
