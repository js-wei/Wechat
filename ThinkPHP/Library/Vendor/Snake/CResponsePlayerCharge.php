...
class CResponsePlayerCharge
{
    ...
    /**
     * @param mixed $ChannelAmout
     */
    public function setChannelAmout($ChannelAmout)
    {
        $this->ChannelAmout = $ChannelAmout;
    }

    /**
     * @return mixed
     */
    public function getChannelAmout()
    {
        return $this->ChannelAmout;
    }
    ...
    /**
     * @param mixed $ResTimestamp
     */
    public function setResTimestamp($ResTimestamp)
    {
     ...
     * @return mixed
     */
    public function getResTimestamp()
    {
